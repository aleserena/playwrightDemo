  ...
  constructor(page, numberOfItemsInCart) {
    ...
    for (let i = 0; i < numberOfItemsInCart; i++) {
      this.itemsInCart.push(
        page.locator(
          `#cart_contents_container > div > div.cart_list > div:nth-child(${i + 3})`,
        ),
      );
    }

    this.nthItemName = (itemNumber) =>
      this.itemsInCart[itemNumber].locator(".inventory_item_name");
    this.nthItemPrice = (itemNumber) =>
      this.itemsInCart[itemNumber].locator(".inventory_item_price");
    this.nthItemQuantity = (itemNumber) =>
      this.itemsInCart[itemNumber].locator(".cart_quantity");
    this.nthItemDescription = (itemNumber) =>
      this.itemsInCart[itemNumber].locator(".inventory_item_desc");
    this.nthItemRemoveButton = (itemNumber) =>
      this.itemsInCart[itemNumber].locator(
    ...
    this.continueShoppingButton = page.locator(
      ".btn btn_secondary back btn_medium",
    );
  }
